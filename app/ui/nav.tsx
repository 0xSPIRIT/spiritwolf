...
export function Navigation(props: NavigationProps) {
  return <div className="fixed left-1/2 transform -translate-x-1/2 w-full max-w-[900px] px-4 bg-black/75 z-15 backdrop-blur-md shadow-lg shadow-black flex rounded-xl flex flex-col">
